      ...
      user
        ...
        .then((result) => {
          transporter.sendMail({
            to: user.email,
            from: "Invoice <PIZEONFLY PRIVATE LIMITED>",
            subject: "Password reset request",
            html: `
                    <p>You requested for password reset from Pizeonfly Invoicing application</p>
                    <h5>Please click this <a href="https://pizeonflyinvoiceapp.vercel.app/reset/${token}">link</a> to reset your password</h5>
                    <p>Link not clickable?, copy and paste the following url in your address bar.</p>
                    <p>https://pizeonflyinvoiceapp.vercel.app/reset/${token}</p>
